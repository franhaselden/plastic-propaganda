...
add_action('init', 'create_slider'); // Add our HTML5 Blank Custom Post Type
...
{
    register_taxonomy_for_object_type('category', 'pp-slider'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'pp-slider');
    register_post_type('pp-slider', // Register Custom Post Type
        array(
        'labels' => array(
            ...
            'not_found' => __('No slide found', 'slider'),
            'not_found_in_trash' => __('No slide found in Trash', 'slider')
        ),
        'public' => true,
